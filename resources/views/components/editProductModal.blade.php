            ...
            <form class="p-4 md:p-5" method="POST" action="{{ route('editProduct') }}" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2 justify-center">
                        <label for="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">@lang('editProductModal.image_label')</label>
                        <div class="my-5">
                            <img src="{{ $product->image }}" alt="Product Image" class="h-32 hover:scale-110 transition-all duration-500 rounded-xl mx-auto" />
                        </div>
                    ...
                    <div class="col-span-2">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">@lang('editProductModal.name_label')</label>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">@lang('editProductModal.price_label')</label>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">@lang('editProductModal.stock_label')</label>
