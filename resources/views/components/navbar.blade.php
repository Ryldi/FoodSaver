    ...
    <div class="flex justify-between items-center container mx-auto">
      ...
      <div class="md:flex md:gap-8">
        <ul class="flex md:gap-4">
            <a href="" class="flex items-center py-1 px-4 md:px-6 rounded-full hover:bg-accent-selected transition-all duration-500 {{ request()->routeIs('order.view') ? 'bg-accent-selected' : '' }} " aria-current="page">
                Home
            </a>
            ...
            <div id="dropdownHover" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                  <li>
                    <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Fast Food</a>
                  </li>
                  <li>
                    <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Bakery & Cake</a>
                  </li>
                </ul>
            </div>
            <a href="" class="flex items-center py-1 px-4 md:px-6 rounded-full hover:bg-accent-selected transition-all duration-500 {{ request()->routeIs('cart.view') ? 'bg-accent-selected' : '' }}">
                Promo
            </a>
            <a href="" class="flex items-center py-1 px-4 md:px-6 rounded-full hover:bg-accent-selected transition-all duration-500 {{ request()->routeIs('cart.view') ? 'bg-accent-selected' : '' }}">
                Tentang Kami
