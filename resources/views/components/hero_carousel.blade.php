                ...
                <div class="relative w-full flex justify-center items-center py-40 px-10" style="background-image: url(' {{ asset('img/hero_carousel/1.jpg') }}'); background-size: cover; background-position: center;">
                    <div class="">
                        ...
                        <div class="relative z-[1] text-white">
                            <h1 class="text-5xl font-bold w-[80%]">Sisa Tak Terbuang, Rasa Tetap Terjaga</h1>
                            <p class="text-lg my-5 w-[60%]">Selamatkan makanan berlebih dari toko makanan dengan harga selalu diskon 50% tanpa syarat!</p>
                            <a type="button" class="text-white text-xl bg-accent hover:bg-accent-hover  rounded-full px-3 py-1.5 text-center me-2 mb-2 cursor-pointer">Lihat Makanan</a>
                        </div>
                    </div>
                    <div class="z-[1]">
                        <img src="{{ asset('img/hero_carousel/hand.png') }}" alt="" width="350">
                    </div>
                </div>
            </div>
            <!-- Item 2 -->
            ...
            <div class="flex gap-4 w-full" data-carousel-item>
                <div class="relative w-full flex justify-center items-center py-40 px-10" style="background-image: url(' {{ asset('img/hero_carousel/3.jpg') }}'); background-size: cover; background-position: center;">
                    <div class="">
                        ...
                        <div class="relative z-[1] text-white">
                            <h1 class="text-5xl font-bold w-[80%]">Sisa Tak Terbuang, Rasa Tetap Terjaga</h1>
                            <p class="text-lg my-5 w-[50%]">Selamatkan makanan berlebih dari toko makanan dengan harga selalu diskon 50% tanpa syarat!</p>
                            <a type="button" class="text-white text-xl bg-accent hover:bg-accent-hover  rounded-full px-3 py-1.5 text-center me-2 mb-2 cursor-pointer">Lihat Makanan</a>
                        </div>
                    </div>
                    <div class="z-[1]">
