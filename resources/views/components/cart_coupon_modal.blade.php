            ...
            <div class="p-4 md:p-5">
                ...
                <ul class="space-y-4 mb-4 max-h-96 overflow-y-auto">
                    ...
                    <li>
                        ...
                        <label for="job-{{ $coupon->id }}" class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-500 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-900 hover:bg-gray-100 dark:text-white dark:bg-gray-600 dark:hover:bg-gray-500">                           
                                    ...
                                    <div class="flex-grow flex flex-col justify-between px-6 py-4 bg-neutral-light border-l border-black">
                                        <div class="flex items-center justify-between p-4 w-full">
                                            ...
                                            <div class="flex flex-col gap-1">
                                                <form action="" method="">
                                                    @csrf
                                                    <button class="flex-shrink-0 gap-1 z-10 inline-flex items-center py-1.5 px-2 text-sm font-medium text-center text-neutral-light bg-accent border border-gray-300 rounded-lg focus:ring-4 focus:outline-none hover:bg-accent-hover" 
                                                            type="submit">
                                                        Use
                                                    </button>
                                                </form>
                                        ...
                                        <div class="flex justify-end items-center">
                                            <p class="text-sm text-gray-500">Berakhir {{ $coupon->end->format('d M Y') }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
