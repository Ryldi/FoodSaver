                    ...
                    <div class="flex items-center justify-between p-4 w-full">
                        ...
                        <div class="flex flex-col gap-1">
                            <form action="{{ route('restaurantDetailPage', ['id' => $item->restaurant->id]) }}" method="GET">
                                @csrf
                                <button class="flex-shrink-0 gap-1 z-10 inline-flex items-center py-1.5 px-6 text-sm font-medium text-center text-neutral-light bg-accent border border-gray-300 rounded-lg focus:ring-4 focus:outline-none hover:bg-accent-hover" 
                                        type="submit">
                                    Use &gt;
                                </button>
                            </form>
